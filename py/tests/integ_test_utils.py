...
class IntegTestHelper:

    @staticmethod
    def launch(test_cls, test_env, script_name):
        ...
        cmd_line = [IntegTestHelper.get_submit_script(test_env.spark_home), "--verbose"]
        ...
        test_cls.assertTrue(return_code == 0, "Process ended in a wrong way. It ended with return code "+str(return_code))
